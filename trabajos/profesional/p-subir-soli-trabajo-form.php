...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4" style="color: #a2a2f4;">Subir Solicitud de Trabajo</h1>
        <form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary" style="background-color: #a2a2f4; border-color: #a2a2f4; font-family: nexa;">Subir Solicitud</button>
        </form>
    </div>
